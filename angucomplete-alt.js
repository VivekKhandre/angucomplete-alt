...
(function (root, factory) {
  ...
  angular.module('angucomplete-alt', [])
    .directive('angucompleteAlt', ['$q', '$compile', '$parse', '$http', '$sce', '$timeout', '$document', '$templateCache', '$interpolate',
      function ($q, $compile, $parse, $http, $sce, $timeout, $document, $templateCache, $interpolate) {
        // keyboard events
        var KEY_DW = 40;
        var KEY_RT = 39;
        var KEY_UP = 38;
